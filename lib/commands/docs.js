...
var exec = require('child_process').exec,
  ...
  prefix = path.join(process.env.HOME, '.gimme', 'cdnjs', 'ajax', 'libs');
...
docs.description = ['docs <name>', "guess the likely location of a package's documentation URL, and then tries to open it using the --browser config param."];
