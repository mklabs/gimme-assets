...
help.usage = ['gimme help <cmd>'];
help.description = ['help <name>', 'Shows the appropriate documentation page for the given command']
...
function help(opts, cb) {
  ...
  // is it a valid topic?
  if(!valid) {
    app.error(topic, 'is not a vaild command');
    return cb();
  }
